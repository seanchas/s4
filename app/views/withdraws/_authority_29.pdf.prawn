...
parent_pdf.text_field("position_agent212", 0, 565-move+6, 218, 15, :default => "#{@vars['ceo_position']}")
parent_pdf.text_field("position_agent212a", 245, 565-move+6, 150, 15, :default => "#{@vars['ceo_fio']}")

parent_pdf.text_field("birth_year", 0, 633-move-4-17, 523, 15)

parent_pdf.text_field("dayx", 260, 700-move-17, 23, 15)
parent_pdf.text_field("monthx", 288, 700-move-17, 80, 15)
parent_pdf.text_field("yearx", 383, 700-move-17, 23, 15)
