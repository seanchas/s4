...
parent_pdf.text_field("vsvyazy", 0, 600-move-8-17-26, 523, 15)

parent_pdf.text_field("position_agent212a", 330, 565-move-13-17-26, 192, 15, :default => "#{@vars['ceo_fio']}")
parent_pdf.text_field("position_agent212", 0, 565-move-13-17-26, 228, 15, :default => "#{@vars['ceo_position']}")
...
parent_pdf.text_field("yearx", 435-5-3, 700-move-17-26, 16, 15)
