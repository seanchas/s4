...
parent_pdf.text "именуем___ в дальнейшем Участник, при совершении сделок с Облигациями согласно установленному ОАО ММВБ-РТС «Регламенту проведения операций в Системе электронных торгов по сделкам с государственными и иными ценными бумагами» с использованием технического доступа к программно-техническому комплексу ОАО ММВБ-РТС (ПТК ММВБ-РТС) и с использованием следующих торговых идентификаторов Участника:", :align => :justify
