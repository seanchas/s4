...
parent_pdf.text_field("phone", 160, 84+9-17, 309, 15)
parent_pdf.text_field("email", 185, 70+5-17, 285, 15)
...
Адрес электронной почты трейдера________________________________________________
...
parent_pdf.text_field("position_agent212", 0, 757, 223, 15, :default => "#{@vars['ceo_position']}")
parent_pdf.text_field("position_agent212a", 238, 757, 169, 15, :default => "#{@vars['ceo_fio']}")