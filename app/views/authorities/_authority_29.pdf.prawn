...
parent_pdf.text "Контактный телефон трейдера:____________________________________________________", :align => :justify, :leading => 4
parent_pdf.text "Адрес электронной почты трейдера:________________________________________________", :align => :justify, :leading => 4
...
parent_pdf.text_field("phone", 162, 742, 309, 15)
parent_pdf.text_field("email", 187, 725, 285, 15)
