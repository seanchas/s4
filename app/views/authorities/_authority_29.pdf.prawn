...
parent_pdf.text_field("birth_place", 220, 643-move+14-18, 300, 15)
parent_pdf.text_field("birth_place2", 0, 643-move+14-18-17, 350, 15)
parent_pdf.text_field("grazdanstvo", 430, 643-move+14-18-17, 90, 15)


parent_pdf.text_field("passport_serial", 75, 610-move+12-17, 35, 15)
parent_pdf.text_field("passport_number", 127, 610-move+12-17, 60, 15)
parent_pdf.text_field("passport_vidan", 230, 610-move+12-17, 285, 15)

parent_pdf.text_field("passport_pole", 0, 585-move+13-17, 523, 15)
parent_pdf.text_field("passport_pole2", 0, 555-move+10-17, 523, 15)
parent_pdf.text_field("passport_pole3", 0, 523-move+7-17, 523, 15, :default => "#{@vars['agent_document']}")

parent_pdf.text_field("phone", 160, 84+9-17, 350, 15)
parent_pdf.text_field("email", 185, 70+5-17, 300, 15)
...
parent_pdf.text "________ года рождения, место рождения ___________________________________________________", :leading => 4
...
", :align => :justify, :leading => 4, :size => 10


parent_pdf.go_to_page 2
parent_pdf.text_field("position_agent212", 0, 757, 225, 15, :default => "#{@vars['ceo_position']}")
parent_pdf.text_field("position_agent212a", 240, 757, 156, 15, :default => "#{@vars['ceo_fio']}")
parent_pdf.text_field("position_agent212b", 420, 757, 80, 15)