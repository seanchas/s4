...
parent_pdf.text_field("position_agent32", 0, 665-move+14, 523, 15, :default => "#{@vars["nbsp_a"]} #{@vars['agent_fio']}")
...
parent_pdf.text_field("birth_year", 0, 643-move+14, 45, 15)
parent_pdf.text_field("birth_place", 220, 643-move+14, 135, 15)
parent_pdf.text_field("grazdanstvo", 430, 643-move+14, 70, 15)
...
parent_pdf.text_field("passport_pole3", 0, 523-move+9, 523, 15, :default => "#{@vars['agent_document']}")

parent_pdf.text_field("phone", 160, 84+10, 350, 15)
parent_pdf.text_field("email", 185, 70+6, 300, 15)
