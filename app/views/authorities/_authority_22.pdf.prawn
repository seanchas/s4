...
parent_pdf.text_field("yaya",44, 178, 20, 15)
parent_pdf.text_field("binban",193, 127, 225, 15)


#parent_pdf.text_field("podp", 48, 301, 300, 15, :default => "#{@vars['ceo_position']}#{@vars["nbsp_c"]} #{@vars['ceo_fio']}")

parent_pdf.text_field("position_agent21512", 0, 85, 523, 15, :default => "#{@vars['agent_fio']}")
parent_pdf.text_field("agent_fio1", 48, 39, 400, 15, :default => @vars['agent_fio'])
