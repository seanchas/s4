...
parent_pdf.text_field("position_agent21512", 0, 774-17-13, 523, 15, :default => "#{@vars['agent_fio']}")

parent_pdf.text_field("agent_fio1", 48, 728-17-13, 400, 15, :default => @vars['agent_fio'])


parent_pdf.text_field("auth_create_day", 232, 704-17-13, 17, 15)
parent_pdf.text_field("auth_create_month", 255, 704-17-13, 60, 15)
parent_pdf.text_field("auth_create_year", 330, 704-17-13, 17, 15)

parent_pdf.text_field("phone_code", 87, 683-17-17-13, 30, 15)
parent_pdf.text_field("phone", 120, 683-17-17-13, 265, 15)

parent_pdf.text_field("agent_podpis", 50, 657-17-17-13, 300, 15, :default => @vars['ceo_position'])
parent_pdf.text_field("name_podp", 390, 657-17-17-13, 95, 15, :default => @vars['cfs'])
