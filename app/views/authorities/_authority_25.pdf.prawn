...
parent_pdf.text_field("vtv_id", 150, 123-16, 175, 15)

parent_pdf.text_field("agent_fio1", 0, 81-7, 523, 15, :default => @vars['agent_fio'])
parent_pdf.text_field("agent_fio2", 48, 33-1, 370, 15, :default => @vars['agent_fio'])
