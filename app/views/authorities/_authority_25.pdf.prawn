...
parent_pdf.text_field("phone_code", 91, 350, 23, 15)
parent_pdf.text_field("phone", 120, 350, 265, 15)

#parent_pdf.text_field("podp", 78, 350, 300, 15, :default => "#{@vars['ceo_position']}#{@vars["nbsp_c"]} #{@vars['ceo_fio']}")

parent_pdf.text_field("agent_podpis", 0, 317, 300, 15, :default => @vars['ceo_position'])
parent_pdf.text_field("name_podp", 425, 317, 95, 15, :default => @vars['cfs'])
