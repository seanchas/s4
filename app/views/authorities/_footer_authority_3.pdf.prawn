parent_pdf.text "\n\n"
parent_pdf.text "Права и обязанности по сделкам с указанными в настоящей Доверенности Облигациями, заключенным #{@vars['agent_fio']} ", :leading => 4, :indent_paragraphs => 30
...
parent_pdf.text "Подпись #{@vars['agent_fio']} _____________________ удостоверяю.", :indent_paragraphs => 30, :leading => 4, :indent_paragraphs => 30
